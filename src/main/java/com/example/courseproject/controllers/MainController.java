...
public class MainController implements Initializable {
  ...
  public void initialize(URL location, ResourceBundle resourceBundle){
      ...
      try  {
          Parent fxml = FXMLLoader.load(getClass().getResource("/com/example/courseproject/public/views/payment.fxml"));
  ...
  public void bill(javafx.event.ActionEvent actionEvent) throws IOException {
        Parent fxml = FXMLLoader.load(getClass().getResource("/com/example/courseproject/public/views/bill.fxml"));
        contentArea.getChildren().removeAll();
        contentArea.getChildren().setAll(fxml);
  }

  public void warehouse(javafx.event.ActionEvent actionEvent) throws IOException {
        Parent fxml = FXMLLoader.load(getClass().getResource("/com/example/courseproject/public/views/warehouse.fxml"));
        contentArea.getChildren().removeAll();
        contentArea.getChildren().setAll(fxml);
  }
  public void dashboard(javafx.event.ActionEvent actionEvent) throws IOException {
        Parent fxml = FXMLLoader.load(getClass().getResource("/com/example/courseproject/public/views/dashboad.fxml"));
        contentArea.getChildren().removeAll();
        contentArea.getChildren().setAll(fxml);
  }
